...
export default function WhatsAppButton() {
    ...
    // Phone number without + and spaces
    const phoneNumber = "905421901757";
        ...
        <div className="fixed bottom-6 right-6 z-50">
            <div className="relative">
                ...
                <a
                    ...
                    className="flex items-center justify-center w-16 h-16 bg-[#25D366] rounded-full shadow-2xl hover:shadow-[0_0_30px_rgba(37,211,102,0.6)] hover:scale-110 transition-all duration-300 group"
                    aria-label="WhatsApp"
                >
                    {/* WhatsApp Icon */}
                    <svg
